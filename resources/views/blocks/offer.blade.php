...
<section
	...
	<div class="c-main ">
		<div class="__posts-grid flex flex-col gap-6 w-full ">
			...
			@endphp
			<div data-gsap-element="card" class="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-6 items-stretch group transition-transform duration-500 hover:-translate-y-2 overflow-hidden">
				<!-- contents-->
