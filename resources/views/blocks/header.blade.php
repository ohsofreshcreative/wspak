...
<section
	...
	class="b-header overflow-hidden h-100 relative {{ $sectionClass }} {{ $section_class }}">
		<div class="blur bg-primary-100 absolute z-20"></div>
	...
	<div class="video-wrapper absolute inset-0 w-full h-full z-1">
		...
		<div class="absolute inset-0 bg-primary-900/90 z-10"></div>

	</div>
	<div class="__content-overlay absolute inset-0 z-20 flex items-center justify-center min-h-[300px] lg:min-h-[400px]">
