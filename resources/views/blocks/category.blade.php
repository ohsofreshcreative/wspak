...
<section
    ...
    <div class="flex md:gap-4 gap-2">
        <x-icon.arrow-left class="js-posts-prev cursor-pointer hover:opacity-30 transition-colors md:h-16 h-10 w-auto duration-300 transition-all" />
        <x-icon.arrow-right class="js-posts-next cursor-pointer hover:opacity-30 transition-colors md:h-16 h-10 w-auto duration-300 transition-all" />
    </div>
</div>
        </div>
