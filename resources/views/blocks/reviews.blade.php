...
=======
	@class([ 'b-reviews relative overflow-hidden -smt -spt -spb bg-[#091838]' ,
>>>>>>> Stashed changes
...
=======
	<div class="absolute right_shape z-12"><img class="" src="{{ get_template_directory_uri() }}/resources/images/shape_s.svg"></div>

	<div class="absolute gradient-left inset-y-0 left-0 w-[60vw] z-10" style="background: linear-gradient(90deg, #091838 0%, rgba(9, 24, 56, 0.00) 100%);"></div>
	<div class="absolute gradient-right inset-y-0 right-0 w-[30vw] z-10" style="background: linear-gradient(90deg, rgba(9, 24, 56, 0.00) 0%, #091838 100%);"></div>
>>>>>>> Stashed changes
...
=======
						<div class="swiper-slide w-[calc(100%/1.5)]! max-w-[calc(100%/1.5)]! px-4!">
							<div class="__card relative px-8 py-14">
								...
								<div class="relative z-10 flex flex-col ">
									...
									<div class="review-content-wrapper text-white">
										...
										<div class="__txt line-clamp-6 text-h4 -mt-10 mb-9 font-normal!">{!! $card['txt'] !!}</div>
									</div>
									@endif
...
=======
					...
					<!-- <div data-gsap-element="arrows" class="absolute top-1/2 left-0 w-full -translate-y-1/2 z-20 flex justify-between items-center pointer-events-none ">
					<div class="__prev  flex items-center justify-center pointer-events-auto -translate-x-1/2 cursor-pointer transition-all duration-400 z-20">
						<x-icon.arrow-left class="cursor-pointer h-10 w-auto z-20" />
					</div>
					<div class="__next  flex items-center justify-center pointer-events-auto translate-x-1/2 cursor-pointer transition-all duration-300 z-20 ">
						<x-icon.arrow-right class="cursor-pointer h-10 w-auto z-20" />
					</div>
				</div> -->
