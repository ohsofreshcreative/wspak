...
{
	public $name = 'Tekst i duże zdjęcie';
	public $description = 'overview - tekst i duże zdjęcie';
	public $slug = 'overview';
	public $category = 'formatting';
	public $icon = 'align-pull-left';
	public $keywords = ['tresc', 'zdjecie', 'overview'];
	public $mode = 'edit';
	public $supports = [
		'align' => false,
		'mode' => false,
	...
	{
		$overview = new FieldsBuilder('overview');
	...
	{
		$fields = [
			'g_overview' => get_field('g_overview'),
