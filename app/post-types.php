...
add_action('acf/init', function() {
    ...
    // Taksonomia: Płeć
    register_taxonomy('voice_gender', ['voices'], [
        'label'        => 'Płeć',
        'hierarchical' => true,
        'show_in_rest' => true,
    ]);
    ...
    // Taksonomia: Wiek głosu
    register_taxonomy('voice_age', ['voices'], [
        'label'        => 'Wiek głosu',
        'hierarchical' => true,
        'show_in_rest' => true,
    ]);
    ...
    // Taksonomia: Barwa głosu
    register_taxonomy('voice_tone', ['voices'], [
        'label'        => 'Barwa głosu',
        'hierarchical' => true,
        'show_in_rest' => true,
    ]);
    ...
    // Taksonomia: Styl interpretacji
    register_taxonomy('voice_style', ['voices'], [
        'label'        => 'Styl interpretacji',
        'hierarchical' => true,
        'show_in_rest' => true,
    ]);


    // Taksonomia: Grupa cenowa
    register_taxonomy('voice_price', ['voices'], [
        'label'        => 'Grupa cenowa',
        'hierarchical' => true,
        'show_in_rest' => true,
    ]);
    ...
    // Taksonomia: Zastosowanie (opcjonalnie)
    register_taxonomy('voice_usage', ['voices'], [
        'label'        => 'Zastosowanie',
        'hierarchical' => true,
        'show_in_rest' => true,
    ]);
